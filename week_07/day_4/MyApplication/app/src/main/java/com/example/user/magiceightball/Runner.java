...
public class Runner {
    public static void main(String[] args){
        ...
        NumberGenerating randomNumberGenerator = new RandomNumberGenerator();
        ...
        Answering answerProvider = new Answers(customAnswers);

        String randomAnswer = answerProvider.getRandomAnswer(randomNumberGenerator);
