    ...
    switch(this.state.playerType) {
      case "PLAYERTYPE_GUESSER":
        playerComponents = (
          ...
          onQuestionSubmit={ this.handleSubmitQuestion.bind(this) } />
        )
      break
      case "PLAYERTYPE_CHOOSER":
        playerComponents = (
          ...
          handleCelebritySubmit={ this.handleCelebritySubmit.bind(this) }
          onAnswerSubmit={ this.handleSubmitAnswer.bind(this) } />
        )
      break
      default:
        playerComponents = (
